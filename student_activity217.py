...
try:
    ...
    def _Radar_callback(radar_data):
        ...
        for detect in radar_data:
            ...
            pitch=new_pitch,yaw=new_yaw,roll=new_roll)).transform(rear_view)
            debug.draw_string(
            	radar_data.transform.location+rear_view,'radar'
            	,life_time=0.06,color=carla.Color(255,150,163))
